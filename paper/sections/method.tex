...
temporal attention (over $S$, independently per entity), then social
attention (over $E$, independently per segment), then a feed-forward layer
--- 6 heads, MLP ratio 4, pre-norm throughout. A learned CLS query
